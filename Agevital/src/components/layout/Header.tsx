...
export function Header() {
  return (
    <header className="relative shrink-0 border-b border-ink/15 bg-paper-alt/90 backdrop-blur-[2px]">
      <div className="flex h-8 lg:h-10 w-full items-center gap-2 px-2">
        <div className="flex flex-1 items-center gap-1.5">
          ...
          <div className="leading-tight">
            <div className="font-serif text-[11px] lg:text-sm font-semibold tracking-wide text-ink">
              龄健 AgeVital
            </div>
            <div className="text-[7px] lg:text-[10px] tracking-wider text-ink-wash leading-none">
        ...
        <nav className="flex shrink-0 items-center gap-0">
          {navItems.map((item) => (
            <NavLink
              ...
              className={({ isActive }) =>
                cn(
                  'group relative flex flex-col justify-center px-2 py-0 text-[9px] lg:text-[11px] tracking-wide transition-colors',
            ...
            >
              {({ isActive }) => (
                <>
                  <span className="font-serif text-[10px] lg:text-xs leading-tight">{item.label}</span>
                  <span
                    className={cn(
